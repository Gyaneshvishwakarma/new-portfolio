    ...
    <section id="blog" className="section-padding bg-muted/20">
      <div className="container mx-auto">
        <h2 className="text-3xl md:text-4xl font-bold mb-4 text-center">
          <span className="text-gradient">From My Blog</span>
        </h2>
        <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
          I write about web development, computer science concepts, and my journey in the MCA program.
        </p>
        ...
        <div className="text-center">
          <Link to="/blog" className="inline-block glass-card px-6 py-3 rounded-lg hover:bg-primary/20 transition-all">
            View All Posts
          </Link>
        </div>
      </div>
